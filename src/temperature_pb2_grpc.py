...
class TemperatureServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLatest = channel.unary_unary(
                '/temperature.TemperatureService/GetLatest',
                request_serializer=temperature__pb2.GetLatestRequest.SerializeToString,
                response_deserializer=temperature__pb2.TemperatureAverage.FromString,
                _registered_method=True)
        self.GetHistory = channel.unary_stream(
                '/temperature.TemperatureService/GetHistory',
                request_serializer=temperature__pb2.GetHistoryRequest.SerializeToString,
                response_deserializer=temperature__pb2.TemperatureAverage.FromString,
                _registered_method=True)
...
def add_TemperatureServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetLatest': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLatest,
                    request_deserializer=temperature__pb2.GetLatestRequest.FromString,
                    response_serializer=temperature__pb2.TemperatureAverage.SerializeToString,
            ),
            'GetHistory': grpc.unary_stream_rpc_method_handler(
                    servicer.GetHistory,
                    request_deserializer=temperature__pb2.GetHistoryRequest.FromString,
                    response_serializer=temperature__pb2.TemperatureAverage.SerializeToString,
            ),
    }
...
class TemperatureService(object):
    ...
    def GetLatest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/temperature.TemperatureService/GetLatest',
            temperature__pb2.GetLatestRequest.SerializeToString,
    ...
    def GetHistory(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/temperature.TemperatureService/GetHistory',
            temperature__pb2.GetHistoryRequest.SerializeToString,
            temperature__pb2.TemperatureAverage.FromString,
            options,
            channel_credentials,
            insecure,
